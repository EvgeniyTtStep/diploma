...
import com.example.diploma.email.events.pswdReset.OnPasswordResetEvent;
...
import com.example.diploma.repositories.users.SchoolRepository;
...
public class PageController {
    ...
    @GetMapping("/register")
    public String register() { return "new_register"; }
    ...
    public String resetPswd() { return "new_pswd_reset_req"; }
    ...
    public String resetPswdPage(@PathVariable String id, @RequestParam String token, Model model) {
        ...
        return "new_pswd_reset_form";
    }

    @PostMapping("/register")
    @ResponseBody
    public RedirectView log_res(@RequestParam String email,
