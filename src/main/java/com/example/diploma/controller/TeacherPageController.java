...
import com.example.diploma.repositories.CalendarDayRepository;
...
public class TeacherPageController {
    ...
    public String teacher_home(@PathVariable Long uid,
        ...
        if (checkAuthResult.equals("**success**")) {
            ...
            model.addAttribute("school", teacher);
            Collection<Gradebook> allgradebooks = teacher.getGradebooks();

            for (Gradebook allgradebook : allgradebooks) {
                System.out.println("allgradebook = " + allgradebook.getName());
                System.out.println("allgradebook semester = " + allgradebook.getSemester().getName());
            }
            ...
            for (Gradebook gradebook: allgradebooks) {
                if (semesters.contains(gradebook.getSemester())) {
                    System.out.println("gradebook = " + gradebook);
                    currgradebooks.add(gradebook);
                }
            }
            ...
            System.out.println("currgradebooks = " + currgradebooks.size());
            for (Gradebook currgradebook : currgradebooks) {
                System.out.println("currgradebook = " + currgradebook.getName());
            }

            return "new_teacher_home";
        } else {
    ...
    public String teacher_info(@PathVariable Long uid,
        ...
        if (checkAuthResult.equals("**success**")) {
            ...
            model.addAttribute("school", userRepo.findById(uid).get().getTeacher());
            return "new_teacher_info";
        } else {
            return checkAuthResult;
        }
    }
